...
**👁️ Diabetic Retinopathy Screening (SIH 2026)**
<br/>
Explainable AI pipeline for grading DR severity in rural India — a MATLAB-based retinal image pipeline with CLAHE preprocessing, EfficientNet-based classification, Grad-CAM explainability, and clinical validation via sensitivity/specificity/AUC. Built for a Smart India Hackathon 2026 (MathWorks) problem statement.

`MATLAB` `Deep Learning Toolbox` `EfficientNet` `Grad-CAM` `Explainable AI`
...
### 03. 🧭 IN TRAINING // SKILLS QUEUE

*Domains I'm actively building depth in right now:*
