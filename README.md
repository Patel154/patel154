[README (6).md](https://github.com/user-attachments/files/31806694/README.6.md)
...
<div align="center">
  ...
  <p align="center">
    <strong>A Builder & Software Engineer crafting full-stack web applications, Android systems, and edge IoT solutions</strong>
  </p>
...
**🏆 Vastu**
<br/>
National hackathon finalist project — a full-stack platform built with RESTful APIs and a SQLite/SQLAlchemy backend, developed and pitched under competition timelines.

`Python` `Flask` `RESTful APIs` `SQLite` `SQLAlchemy`
...
| 🩺 | **Explainable Healthcare AI** | **Diabetic Retinopathy Screening (SIH 2026)** — MATLAB-based retinal image pipeline: CLAHE preprocessing & quality filtering, EfficientNet-based DR severity classification, Grad-CAM explainability, and clinical validation via sensitivity/specificity/AUC | ![Active](https://img.shields.io/badge/Status-Hackathon_Build-F7DF1E?style=flat-square&logoColor=black) |
...
<p><strong>Backend, Cloud & Database</strong></p>
...
&nbsp;
<img src="https://img.shields.io/badge/REST_APIs-0052CC?style=for-the-badge&logo=fastapi&logoColor=white" alt="REST APIs" />

<br/><br/>

<!-- Mobile & IoT / Embedded -->
<p><strong>Mobile & IoT / Embedded</strong></p>
...
&nbsp;
<img src="https://img.shields.io/badge/Google_Gemini_API-8E75B2?style=for-the-badge&logo=googlegemini&logoColor=white" alt="Gemini API" />
&nbsp;
...
<p>
  <em>Turning caffeine into commits. ☕ → 💻</em>
</p>
